...
class ContractorApplication(models.Model):
    ...
    contractor = models.ForeignKey(UserLogin, on_delete=models.CASCADE, related_name='contractor_applications')
...
class ProgressUpdate(models.Model):
    ...
    updated_by = models.ForeignKey(UserLogin, on_delete=models.SET_NULL, null=True)
