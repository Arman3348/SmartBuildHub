...
class Project(models.Model):
    ...
    homeowner = models.ForeignKey(UserLogin,on_delete=models.CASCADE,related_name='project_homeowner')
    contractor = models.ForeignKey(UserLogin,on_delete=models.SET_NULL,null=True, blank=True,related_name='project_contractor')
